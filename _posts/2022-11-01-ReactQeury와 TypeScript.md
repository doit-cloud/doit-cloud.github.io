...
반대로 queryString을 사용하는 경우가 적기 때문에,

그에 따른 타입과 사용법이 조금씩 다릅니다.
...
1. **TVariables**
    ...
    `mutate` 함수에 전달할 인자를 지정하는 generic 타입입니다. 
...
1. ****TContext****
    ...
    솔직히 해당 타입은 저도 제대로 사용해본 적이 적어 어떤 용도로 사용되는지는 정확히 알지 못합니다.
